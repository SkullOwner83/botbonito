        ...
        while True:
            try:
                ...
                if meta_data.get('message_type') == 'notification':
                    ...
                    if meta_data.get('subsciption_type') == 'channel.follow': self.on_channel_follower(event_data['payload'])
                    if meta_data.get('subsciption_type') == 'channel.subscribe': self.on_channel_subscription(event_data['payload'])
